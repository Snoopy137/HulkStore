 ...
 * @author linux
 */
public class IngresoMercaderia extends javax.swing.JDialog {

    /**
     * Creates new form IngresoMercaderia
     */
    public IngresoMercaderia(java.awt.Frame parent, boolean modal, Producto prod) {
        super(parent, modal);
        initComponents();
        llenarCampos(prod);
    }
    ...
    private void BTNguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNguardarActionPerformed
        try {
            //actualiza stock con dato ingresado por usuario al formulario
            Producto prod = new Producto(TXTdescripcion.getText(),Integer.parseInt(TXTstock.getText()),TXTcodigo.getText().toUpperCase());
            int resultado = AccionesProductos.ingresoMercaderia(prod, Integer.parseInt(TXTcantidad.getText()));
            switch (resultado) {
    ...
    // se llenan los campos con datos actuales
